...
/* BINDTOOL_HEADER_FILE_HASH(4b1f3850f22ad7eebc5527bfbeb058ac) */
/***********************************************************************************/
...
void bind_Hsync(py::module &m) {
  ...
  py::class_<Hsync, gr::block, gr::basic_block, std::shared_ptr<Hsync>>(
      ...
      .def(py::init(&Hsync::make), py::arg("Htotal"), py::arg("delay"),
           D(Hsync, make))

      .def("set_Htotal_and_delay", &Hsync::set_Htotal_and_delay,
           py::arg("Htotal"), py::arg("delay"), D(Hsync, set_Htotal_and_delay))
