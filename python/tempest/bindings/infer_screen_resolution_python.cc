...
void bind_infer_screen_resolution(py::module &m) {
  ...
  py::class_<infer_screen_resolution, gr::block, gr::basic_block,
             std::shared_ptr<infer_screen_resolution>>(
      m, "infer_screen_resolution", D(infer_screen_resolution))

      .def(py::init(&infer_screen_resolution::make), py::arg("sample_rate"),
           py::arg("fft_size"), py::arg("refresh_rate"),
           py::arg("automatic_mode"), D(infer_screen_resolution, make))
