...
/* BINDTOOL_HEADER_FILE_HASH(00d8b6f2eafe62291155631d8b612bd8)                     */
/***********************************************************************************/
...
void bind_frame_drop(py::module& m)
{
    ...
    py::class_<frame_drop, gr::block, gr::basic_block, std::shared_ptr<frame_drop>>(
        m, "frame_drop", D(frame_drop))
