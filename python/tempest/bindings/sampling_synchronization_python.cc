...
/* BINDTOOL_HEADER_FILE_HASH(285ebbfbd6ce42068a267b547a63a9ff) */
/***********************************************************************************/
...
void bind_sampling_synchronization(py::module &m) {
  ...
  py::class_<sampling_synchronization, gr::block, gr::basic_block,
      ...
      .def(py::init(&sampling_synchronization::make), py::arg("Htotal"),
           py::arg("manual_correction"), D(sampling_synchronization, make))

      .def("set_Htotal", &sampling_synchronization::set_Htotal,
           py::arg("Htotal"), D(sampling_synchronization, set_Htotal))
